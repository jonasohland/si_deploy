...
exports.LocalHeadtracker = exports.SerialHeadtracker = exports.FirmwareManager = exports.IEMOutputAdapter = exports.OSCOutputAdapter = exports.UDPOutputAdapter = exports.OutputAdapter = exports.QuaternionContainer = void 0;
...
class OutputAdapter extends events_1.EventEmitter {
}
...
class LocalHeadtracker extends headtracker_1.Headtracker {
    ...
    getID() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.shtrk.getValue(si_gy_values.SI_GY_ID)).readUInt8(0);
        });
    }
    setSamplerate(sr) {
        return __awaiter(this, void 0, void 0, function* () {
