...
exports.UsersManager = exports.NodeUsersManager = exports.SpatializedInput = exports.User = void 0;
...
class UsersManager extends core_1.ServerModule {
    ...
    init() {
        ...
        this.handleWebInterfaceEvent('user.xtc', (socket, node, data) => {
            this.emitToModule(node.id(), dsp_node_1.DSPModuleNames.GRAPH_BUILDER, dsp_graph_builder_1.GraphBuilderInputEvents.MODIFY_XTC, data.user, data.xtc);
        });
