...
exports.AudioDevices = exports.NodeAudioDevices = exports.NodeAudioDeviceSettings = exports.NodePlaybackSettings = exports.NodeSelectedAudioDeviceSettings = exports.AudioDeviceConfiguration = void 0;
    ...
    init() {
        ...
        this.handleWebInterfaceEvent('channellist', (socket, node) => {
            node.audio_devices.getChannelList()
                .then(chlist => {
                log.debug(web_interface_defs_1.webifResponseEvent(node.id(), 'audiosettings', 'channellist'));
